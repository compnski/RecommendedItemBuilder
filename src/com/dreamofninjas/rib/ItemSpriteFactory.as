...
package com.dreamofninjas.rib
{
    ...
    public class ItemSpriteFactory {
       ...
       private static var itemsById:Object = {
        3005: new ItemSprite(3005, new ID3005()),
        3134: new ItemSprite(3134, new ID3134()),
        3050: new ItemSprite(3050, new ID3050()),
        1018: new ItemSprite(1018, new ID1018()),
        3083: new ItemSprite(3083, new ID3083()),
        3001: new ItemSprite(3001, new ID3001()),
        3057: new ItemSprite(3057, new ID3057()),
        3140: new ItemSprite(3140, new ID3140()),
        3082: new ItemSprite(3082, new ID3082()),
        3141: new ItemSprite(3141, new ID3141()),
        1053: new ItemSprite(1053, new ID1053()),
        3010: new ItemSprite(3010, new ID3010()),
        3142: new ItemSprite(3142, new ID3142()),
        3097: new ItemSprite(3097, new ID3097()),
        2039: new ItemSprite(2039, new ID2039()),
        3075: new ItemSprite(3075, new ID3075()),
        1043: new ItemSprite(1043, new ID1043()),
        1051: new ItemSprite(1051, new ID1051()),
        1011: new ItemSprite(1011, new ID1011()),
        3072: new ItemSprite(3072, new ID3072()),
        3003: new ItemSprite(3003, new ID3003()),
        1036: new ItemSprite(1036, new ID1036()),
        3101: new ItemSprite(3101, new ID3101()),
        2003: new ItemSprite(2003, new ID2003()),
        3109: new ItemSprite(3109, new ID3109()),
        3099: new ItemSprite(3099, new ID3099()),
        3115: new ItemSprite(3115, new ID3115()),
        3028: new ItemSprite(3028, new ID3028()),
        3065: new ItemSprite(3065, new ID3065()),
        1005: new ItemSprite(1005, new ID1005()),
        2043: new ItemSprite(2043, new ID2043()),
        3009: new ItemSprite(3009, new ID3009()),
        1055: new ItemSprite(1055, new ID1055()),
        3128: new ItemSprite(3128, new ID3128()),
        3114: new ItemSprite(3114, new ID3114()),
        1031: new ItemSprite(1031, new ID1031()),
        1056: new ItemSprite(1056, new ID1056()),
        1006: new ItemSprite(1006, new ID1006()),
        3126: new ItemSprite(3126, new ID3126()),
        1037: new ItemSprite(1037, new ID1037()),
        3024: new ItemSprite(3024, new ID3024()),
        3131: new ItemSprite(3131, new ID3131()),
        1058: new ItemSprite(1058, new ID1058()),
        3006: new ItemSprite(3006, new ID3006()),
        3067: new ItemSprite(3067, new ID3067()),
        3031: new ItemSprite(3031, new ID3031()),
        3068: new ItemSprite(3068, new ID3068()),
        1029: new ItemSprite(1029, new ID1029()),
        3152: new ItemSprite(3152, new ID3152()),
        3106: new ItemSprite(3106, new ID3106()),
        3091: new ItemSprite(3091, new ID3091()),
        3004: new ItemSprite(3004, new ID3004()),
        1007: new ItemSprite(1007, new ID1007()),
        1054: new ItemSprite(1054, new ID1054()),
        1057: new ItemSprite(1057, new ID1057()),
        3098: new ItemSprite(3098, new ID3098()),
        3102: new ItemSprite(3102, new ID3102()),
        2042: new ItemSprite(2042, new ID2042()),
        3135: new ItemSprite(3135, new ID3135()),
        1038: new ItemSprite(1038, new ID1038()),
        3022: new ItemSprite(3022, new ID3022()),
        3070: new ItemSprite(3070, new ID3070()),
        3026: new ItemSprite(3026, new ID3026()),
        3124: new ItemSprite(3124, new ID3124()),
        1004: new ItemSprite(1004, new ID1004()),
        3117: new ItemSprite(3117, new ID3117()),
        3100: new ItemSprite(3100, new ID3100()),
        2004: new ItemSprite(2004, new ID2004()),
        1027: new ItemSprite(1027, new ID1027()),
        3046: new ItemSprite(3046, new ID3046()),
        3071: new ItemSprite(3071, new ID3071()),
        3154: new ItemSprite(3154, new ID3154()),
        3123: new ItemSprite(3123, new ID3123()),
        2044: new ItemSprite(2044, new ID2044()),
        3111: new ItemSprite(3111, new ID3111()),
        3078: new ItemSprite(3078, new ID3078()),
        2037: new ItemSprite(2037, new ID2037()),
        3145: new ItemSprite(3145, new ID3145()),
        3105: new ItemSprite(3105, new ID3105()),
        3138: new ItemSprite(3138, new ID3138()),
        1052: new ItemSprite(1052, new ID1052()),
        3047: new ItemSprite(3047, new ID3047()),
        3093: new ItemSprite(3093, new ID3093()),
        3096: new ItemSprite(3096, new ID3096()),
        1042: new ItemSprite(1042, new ID1042()),
        3044: new ItemSprite(3044, new ID3044()),
        3143: new ItemSprite(3143, new ID3143()),
        3077: new ItemSprite(3077, new ID3077()),
        3035: new ItemSprite(3035, new ID3035()),
        3037: new ItemSprite(3037, new ID3037()),
        3132: new ItemSprite(3132, new ID3132()),
        3041: new ItemSprite(3041, new ID3041()),
        3108: new ItemSprite(3108, new ID3108()),
        3116: new ItemSprite(3116, new ID3116()),
        1026: new ItemSprite(1026, new ID1026()),
        3086: new ItemSprite(3086, new ID3086()),
        1028: new ItemSprite(1028, new ID1028()),
        2038: new ItemSprite(2038, new ID2038()),
        3146: new ItemSprite(3146, new ID3146()),
        3069: new ItemSprite(3069, new ID3069()),
        1001: new ItemSprite(1001, new ID1001()),
        3144: new ItemSprite(3144, new ID3144()),
        1033: new ItemSprite(1033, new ID1033()),
        3136: new ItemSprite(3136, new ID3136()),
        3027: new ItemSprite(3027, new ID3027()),
        3110: new ItemSprite(3110, new ID3110()),
        3020: new ItemSprite(3020, new ID3020())
                                             };
